package co.com.url_shortener.config;

import co.com.url_shortener.model.agreeement.gateway.AgreementRepository;
import co.com.url_shortener.usecase.getAgreement.GetAgreementUseCase;
...
@Configuration
@ComponentScan(basePackages = "co.com.url_shortener.usecase",
        includeFilters = {
